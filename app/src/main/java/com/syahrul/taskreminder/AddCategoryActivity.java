...
public class AddCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CategoryAdapter adapter = new CategoryAdapter(AddCategoryActivity.this, cat2);
    ...
    public void delete(View v) {
        ...
        if (!MainActivity.cat.get(position).getName().equals("none")) {
            ...
            CategoryAdapter a = (CategoryAdapter) mListView.getAdapter();
            ((TextView) findViewById(R.id.nb_cat)).setText("Categories (" + String.valueOf(cat2.size()) + ")");
    ...
    public void dialog(View view) {
        ...
        dialog.setContentView(R.layout.add_cat);
        ...
        dialog.findViewById(R.id.ok).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ok) {
                    MainActivity.cat.add(new Category(name, finalColor));
                    cat2.add(new Category(name, finalColor));
                    CategoryAdapter a = (CategoryAdapter) mListView.getAdapter();
                    ((TextView) findViewById(R.id.nb_cat)).setText("Categories (" + String.valueOf(cat2.size()) + ")");
                    a.notifyDataSetChanged();
                    dialog.dismiss();
